        ...
        plugins: {
          ...
          legend: {
            ...
            labels: {
              color: "#4b5563",
              font: {
                size: 11, // Slightly smaller font to fit extra item
...
<template>
  <div class="card bg-white border border-green-100 shadow-sm h-full">
    <div class="card-body p-5 flex flex-col h-full">
      <div>
        <h3 class="text-lg font-bold text-gray-800 mb-1">Transport Modes</h3>
        <p class="text-xs text-gray-500 mb-4">Breakdown by frequency</p>
      </div>
