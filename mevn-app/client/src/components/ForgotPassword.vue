  ...
  <div class="min-h-screen flex items-center justify-center p-4 transition-colors duration-300">
    ...
    <div class="w-full max-w-sm p-8">
      ...
      <div class="flex flex-col items-center mb-10">
        ...
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white tracking-tight mt-6 mb-2">
          Reset Password
        </h2>
      </div>
      ...
      <div v-if="forgotPasswordError" class="alert alert-error mb-4 rounded-full shadow-md">
        <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
